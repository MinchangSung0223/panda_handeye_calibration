...
RUN /bin/bash -c "rm -r ~/catkin_ws/src/panda_simulator; rm -r ~/catkin_ws/src/franka_panda_description;rm -r ~/catkin_ws/src/franka_ros_interface;"
RUN /bin/bash -c "cd ~/catkin_ws/src;git clone https://github.com/ros-planning/panda_moveit_config.git -b melodic-devel"
